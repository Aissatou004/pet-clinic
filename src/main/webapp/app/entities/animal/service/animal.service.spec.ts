...
import { AnimalService, RestAnimal } from './animal.service';

const requireRestSample: RestAnimal = {
...
describe('Animal Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Animal', () => {
      ...
      service.create(animal).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Animal', () => {
      ...
      service.update(animal).subscribe(resp => (expectedResult = resp));
    ...
    describe('addAnimalToCollectionIfMissing', () => {
      it('should add a Animal to an empty array', () => {
        ...
        expect(expectedResult).toEqual([animal]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([animal, animal2]);
      });

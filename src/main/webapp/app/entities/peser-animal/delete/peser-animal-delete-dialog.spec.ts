...
import { PeserAnimalDeleteDialog } from './peser-animal-delete-dialog';

describe('PeserAnimal Management Delete Component', () => {
  let comp: PeserAnimalDeleteDialog;
  let fixture: ComponentFixture<PeserAnimalDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PeserAnimalDeleteDialog);

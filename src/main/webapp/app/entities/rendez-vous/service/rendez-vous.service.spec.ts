...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../rendez-vous.test-samples';
...
describe('RendezVous Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a RendezVous', () => {
      ...
      service.create(rendezVous).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a RendezVous', () => {
      ...
      service.update(rendezVous).subscribe(resp => (expectedResult = resp));
    ...
    describe('addRendezVousToCollectionIfMissing', () => {
      it('should add a RendezVous to an empty array', () => {
        ...
        expect(expectedResult).toEqual([rendezVous]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([rendezVous, rendezVous2]);
      });

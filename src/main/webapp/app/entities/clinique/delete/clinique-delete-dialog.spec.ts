...
import { CliniqueDeleteDialog } from './clinique-delete-dialog';

describe('Clinique Management Delete Component', () => {
  let comp: CliniqueDeleteDialog;
  let fixture: ComponentFixture<CliniqueDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CliniqueDeleteDialog);
